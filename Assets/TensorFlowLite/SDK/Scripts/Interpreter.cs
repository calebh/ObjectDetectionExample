...
namespace TensorFlowLite {
    ...
    public class Interpreter : IDisposable {
        ...
        public void UseNNAPI(bool enable) {
            TFL_UseNNAPI(handle, enable);
        }

        public void SetNumThreads(int numThreads) {
            TFL_SetNumThreads(handle, numThreads);
        }
        ...
        [DllImport(TensorFlowLibrary)]
        private static extern unsafe void TFL_UseNNAPI(
            TFL_Interpreter interpreter, bool enable);

        [DllImport(TensorFlowLibrary)]
        private static extern unsafe void TFL_SetNumThreads(
            TFL_Interpreter interpreter, int num_threads);
